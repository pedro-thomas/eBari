...
class Paciente(models.Model):
    ...
    address_city = models.ForeignKey(
        'registers.City', on_delete=models.CASCADE,
        null=False,
        blank=False, 
        verbose_name="Cidade",
    )
    ...
    income_family= models.CharField(
        max_length=25,
        choices=HOUSING_TYPE_CHOICES,
        verbose_name="Renda Familiar (em salarios minimos)",
        null=False,
        blank=False, 
    )
    ...
    residents_number = models.PositiveSmallIntegerField(
        null=False,
        blank=False, 
        verbose_name="Quantidade de moradores"
    )

    offspring_number = models.PositiveSmallIntegerField(
        null=False,
        blank=False, 
        verbose_name="Quantidade de filhos"
    )
    ...
    reason_consultation = models.CharField(
        max_length=50,
